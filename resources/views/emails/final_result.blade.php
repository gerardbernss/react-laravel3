...
<body>
    ...
    <p>
        This email is to inform you about the final result of your application (Application No:
    ...
    <p>
        Please log in to your applicant portal for more details or contact the admissions office if you have any
        questions.
    </p>
