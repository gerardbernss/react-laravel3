    ...
    public function storeLES(Request $request)
    {
        ...
        try {
            ...
            if ($request->application_number) {
                ...
                if (Applicant::where('application_number', $manualNumber)->exists()) {
            ...
            $application = Applicant::forceCreate([
...
// Edit an existing application.
    ...
    /**
     * Generate portal credentials and email them to the applicant right after submission.
     * Called outside the DB transaction so a mail failure never rolls back the application.
     */
