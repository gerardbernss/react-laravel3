...
class PublicApplicantController extends Controller
{
    ...
    /**
     * Show the form for creating a new resource for LES.
     *
     * @return \Inertia\Response
     */
    ...
    /**
     * Show the form for creating a new resource for JHS.
     *
     * @return \Inertia\Response
     */
    ...
    /**
     * Show the form for creating a new resource for SHS.
     *
     * @return \Inertia\Response
     */
    ...
    /**
     * Get the application prefix letter based on the year level.
     *
    ...
    /**
     * Format the health conditions input.
     *
     * @param  mixed  $input
     * @return string
     */
