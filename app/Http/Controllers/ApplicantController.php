...
class ApplicantController extends Controller
{
    ...
    {
        // Performance Optimization: Select only necessary columns to reduce memory usage and payload size.
        // This avoids fetching large blobs of unused data (e.g., family background, documents) for the list view.
